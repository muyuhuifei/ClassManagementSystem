...
insert into student values(1215,"fonxian",1234,1);
insert into student values(1210,"bitchgang",1234,1);
#在学生的表中加入一个字段
alter table student add password int(20) default 888888;
alter table student add status int(10) default 0;
#在老师的表中加入一个字段
alter table teacher add password int(20) default 888888;
alter table teacher add status int(10) default 1;
#查看表
select * from student;
...
#查找用户信息通过学号和姓名
select * from student where sid=1201 and sname='方志杰';